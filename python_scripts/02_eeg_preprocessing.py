...
for i in range(new_events[:, 2].size):
    ...
    if new_events[:, 2][i] in {112, 113, 12, 13, 76, 77, 78, 79, 80, 81}
        continue
    elif new_events[:, 2][i] == 70:
        if new_events[:, 2][i + 1] in {112, 113}:
            new_events[:, 2][i] == 111
            continue
        elif new_events[:, 2][i + 1] == 76:
            if new_events[:, 2][i + 2] == 13:
                new_events[:, 2][i] == 11
                continue
            elif new_events[:, 2][i + 2] == 112:
                new_events[:, 2][i] == 10
                continue
